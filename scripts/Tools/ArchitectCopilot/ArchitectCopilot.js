...
ArchitectCopilot.SYSTEM_PROMPT =
    ...
    + "        ORIENT them with face=\"N\"|\"E\"|\"S\"|\"W\" (default N): face names the wall\n"
    + "        the BACK sits against (headboard/sofa backrest/counter/toilet tank), so\n"
    + "        the front opens INTO the room. e.g. a bed with its head on the south\n"
    + "        wall = fixture_bed(pos, face=\"S\"); a sink on the east wall = face=\"E\".\n"
    + "        Push furniture against walls and pick face so it opens into the room.\n"
